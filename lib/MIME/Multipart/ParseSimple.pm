...
MIME::Multipart::ParseSimple - simple mime multipart parser, maintains document order
...
Created a new MIME::Multipart::ParseSimple
...
Please report any bugs or feature requests to C<bug-mime-multipart-parsesimple at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=MIME-Multipart-ParseSimple>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc MIME::Multipart::ParseSimple
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=MIME-Multipart-ParseSimple>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/MIME-Multipart-ParseSimple>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/MIME-Multipart-ParseSimple>

=item * Search CPAN

L<http://search.cpan.org/dist/MIME-Multipart-ParseSimple/>
